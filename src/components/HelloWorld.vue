<template>
  <div class="modal">
    <div class="modal-title">
      <img src="/photo.jpg" alt="twitch-logo" width="100" height="100" />
      <h1>Banky_Zranky</h1>
    </div>
    <div class="modal-content">
      <a
        href="https://www.twitch.tv/banky_zranky"
        class="link-container telegram"
      >
        <div class="icon-container icon-container-twitch">
          <svg
            data-v-57157ab8=""
            width="22"
            height="22"
          ...
          >
            <path
              ...
              fill="currentColor"
            ></path>
            <path d="m10.385 6.262h2.09v6.26h-2.09z" fill="currentColor"></path>
            <path
              d="m16.133 6.262h2.091v6.26h-2.091z"
              fill="currentColor"
            ></path>
          </svg>
        </div>
        <div class="link">
          <h4>Twitch</h4>
          <p>twitch.tv/banky_zranky</p>
        </div>
      </a>
      <a href="https://t.me/banky_zranky" class="link-container telegram">
        <div class="icon-container icon-container-telegram">
          <svg
            data-v-57157ab8=""
            width="20"
            height="20"
        ...
        <div class="link">
          <h4>Telegram</h4>
          <p>t.me/banky_zranky</p>
        </div>
      </a>
      <a href="https://www.instagram.com/banky_zranky" class="link-container">
        <div class="icon-container icon-container-instagram">
          <svg
            data-v-57157ab8=""
            width="24"
            height="24"
        ...
        <div class="link">
          <h4>Instagram</h4>
          <p>instagram.com/banky_zranky</p>
        </div>
      </a>
    </div>
  </div>
  ...
  &-content {
    ...
    .link-container {
      ...
      .icon-container {
        ...
        border-radius: 12px;
        &-telegram {
          background-color: rgba(31, 101, 222, 0.2);
        }
        &-instagram {
          background-color: rgba(192, 0, 122, 0.2);
        }
        &-twitch {
